...
type EditionRead struct {
	...
	Comments  []primitive.ObjectID `json:"comments" bson:"comments" binding:"required"`
}
...
type EditionUpdate struct {
	...
	Comments  []primitive.ObjectID `json:"comments" bson:"comments,omitempty" binding:"dive"`
}
